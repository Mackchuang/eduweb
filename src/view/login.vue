<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item prop="UserAct">
      <el-input type="text" v-model="ruleForm2.UserAct" auto-complete="off" placeholder="账号"></el-input>
    </el-form-item>
      ...
      Login() {
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            ...
            //登录主页跳转
            // this.$http.login(__self.ruleForm2).then((json)=>{
            //     if(json.data.isSucc){
            //         __self.$store.dispatch('loginSucc',json.data.result);
            //         __self.$router.push({
